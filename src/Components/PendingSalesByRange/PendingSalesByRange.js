import './PendingSalesByRange.css';
...
function PendingSalesByRange () {
    ...
    const {toPDF, targetRef} = usePDF({filename: `Reporte de Cobranza(${fechaInicial} - ${fechaFinal}).pdf`});
    ...
    const getData = async () => {
        try {
            ...
            const respuesta = await axios({
                method: 'POST',
                url: net_base_url+'/CXC_reportes.asmx/Reporte_ventas_pendientes_fechas',
    ...
    return <div>
        <div className='controlsContainer'>
            <div className='controlItem'>
                ...
                <ExportExcel 
                    excelData={excelData} 
                    fileName={`Reporte de Cobranza(${fechaInicial} - ${fechaFinal})`}
                    sheetName="Reporte" />
        </div>
        ...
        <div className='cxcReportContainer' ref={targetRef}>
            ...
            <div className='titleContainer'>
                ...
                <h1 className='ReportTitle'>Reporte de Cobranza ({fechaInicial} - {fechaFinal})</h1>
            </div>
...
export default PendingSalesByRange;