...
function TotalValue () {
    ...
    const {toPDF, targetRef} = usePDF({filename: `ClientesFrecuentesValor(${moment().format('DD-MM-YYYY hh:mm')}).pdf`});
    ...
    const getData = async () => {
        try {
            ...
            const respuesta = await axios({
                method: 'POST',
                url: net_base_url+'/CXC_reportes.asmx/Reporte_clientes_frecuentes_compra_total',
    ...
    return <div>
        ...
        <div className='customerFrecuencyReportContainer' ref={targetRef}>
            ...
            <div className='titleCustomerFrecuencyContainer'>
                ...
                <h1 className='ReportCustomerFrecuencyTitle'>Clientes frecuentes (Valor total)</h1>
            </div>
            <div className='tableCustomerFrecuencyContainer'>
