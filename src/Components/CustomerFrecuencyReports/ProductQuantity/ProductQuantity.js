...
function ProductQuantity () {
    ...
    const {toPDF, targetRef} = usePDF({filename: `ClientesFrecuentesTotalProductos(${moment().format('DD-MM-YYYY hh:mm')}).pdf`});
    ...
    const getData = async () => {
        try {
            ...
            const respuesta = await axios({
                method: 'POST',
                url: net_base_url+'/CXC_reportes.asmx/Reporte_clientes_frecuentes_cantidad_producto',
    ...
    return <div>
        <div className='controlsContainer'>
            ...
            <ExportExcel 
                excelData={excelData} 
                fileName={`ClientesFrecuentesTotalProductos(${moment().format('DD-MM-YYYY hh:mm')})`}
                sheetName="Reporte" />
        </div>
        ...
        <div className='customerFrecuencyReportContainer' ref={targetRef}>
            ...
            <div className='titleCustomerFrecuencyContainer'>
                ...
                <h1 className='ReportCustomerFrecuencyTitle'>Clientes frecuentes (Cantidad producto)</h1>
            </div>
            <div className='tableCustomerFrecuencyContainer'>
